...
ActiveRecord::Schema[7.0].define(version: 2023_06_20_040819) do
  ...
  create_table "images", force: :cascade do |t|
    ...
    t.index ["image_name"], name: "index_images_on_image_name", unique: true
    t.index ["storage_name"], name: "index_images_on_storage_name", unique: true
  end
